...
export const reposController = async (req, res) => {
  try {
    ...
    const cacheKey = `repos_${username}_${theme}_${count}_${getWidgetCacheKeySuffix(widgetOptions)}`;
    ...
    const svg = addSvgCredit(generateRepoCard(repos, themeObj), widgetOptions);
